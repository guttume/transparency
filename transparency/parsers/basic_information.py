class BasicInformationParser:
    ...
    FUND_MANAGEMENT = '//tr[@id="32f3bde967894662b11458d1c48d0a2d"]/td/div/div/div/div/label/' \
                      'img[@src="/Style/img/checkedradio.png"]/following-sibling::span/b/text()'
    SUB_ADVISED_PRODUCTS = '//tr[@id="336bca6d619f473d853ec277caed8e8a"]/td/div/div/div/div/label/' \
                           'img[@src="/Style/img/checkedradio.png"]/following-sibling::span/b/text()'
    OTHER_SERVICES = '//tr[@id="d896a5424372407589eeddc43843cd5e"]/td/div/div/div/div/label/' \
                     'img[@src="/Style/img/checkedradio.png"]/following-sibling::span/b/text()'
    FURTHER_SERVICES = '//h3[contains(text(), "Further options")]/parent::div/following-sibling::div/div/div/label/' \
                       'img[@src="/Style/img/checkedcheckbox.png"]/following-sibling::span/b/text()'
    COMPANY_DETAILS = '//h3[contains(text(), "01.2")]/parent::div[contains(@class, "sub-question")]' \
                      '/following-sibling::div/span/p/text()'
    HEADQUARTERS = '//div[@class="countries"]//span[@class="response"]//text()'
    COUNTRY_OFFICES = '//h3[contains(text(), "02.2")]/ancestor::div[@class="radio_parent"]/div/div/div/' \
                      'label/img[@src="/Style/img/checkedradio.png"]/following-sibling::span/b/text()'
    TOTAL_STAFF = '//h3[contains(text(), "number of staff")]/ancestor::div[@class="group"]/div/div/div/' \
                  'span[@class="response number"]/text()'
    HAVE_SUBSIDIARIES = '//h3[contains(text(), 3.1)]/ancestor::div[@class="radio_parent"]/div/div/div/label/' \
                        'img[@src="/Style/img/checkedradio.png"]/following-sibling::span/b/text()'
    YEAR_END = '//h3[contains(text(), "4.1")]/ancestor::div[@class="group"]/div/div/div/' \
               'span[@class="response date"]/text()'
    ...
    SUBSIDIARIES_DETAILS = '//h3[contains(text(), "03.3")]/parent::div[contains(@class, "sub-question")]' \
                           '/following-sibling::div/span/p/text()'
    AUM_DETAILS = '//h3[contains(text(), "04.5")]/parent::div[contains(@class, "sub-question")]' \
                  '/following-sibling::div/span/p/text()'
    AUM_CURRENCY = '//select[@id="ea7f13c4520843fa8d40d90e26f03056"]/option[@selected="selected"]/text()'

    SUBJECT_TO_EXECUTION = '//h3[contains(text(), 04.4)]/parent::div/following-sibling::div/div/div/div/div/label/' \
                           'img[@src="/Style/img/checkedcheckbox.png"]/following-sibling::span/b/text()'
    DISCLOSE_ASSET = '//h3[contains(text(), "06.1")]/parent::div/following-sibling::div/div/div/div/div/label/' \
                     'input[@checked="checked"]/following-sibling::span/b/text()'
    OFF_BALANCE_SHEET = '//h3[contains(text(), "06.3")]/parent::div/following-sibling::div/div/div/label/' \
                        'img[@src="/Style/img/checkedradio.png"]/following-sibling::span/b/text()'

    FIDUCIARY_MANAGERS = '//h3[contains(text(), "06.3")]/parent::div/following-sibling::div/div/div/label/' \
                         'img[@src="/Style/img/checkedradio.png"]/following-sibling::span/b/text()'
